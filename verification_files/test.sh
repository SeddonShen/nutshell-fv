...
python3 run_sby.py --results-dir results_E1 --end-id 43 --workers 20
python3 calculate.py --work-dir ./results_E1 > result_E1.txt
python3 run_sby.py --results-dir results_E2 --end-id 43 --workers 20
python3 calculate.py --work-dir ./results_E2 > result_E2.txt
python3 run_sby.py --results-dir results_E3 --end-id 43 --workers 20
python3 calculate.py --work-dir ./results_E3 > result_E3.txt
python3 run_sby.py --results-dir results_E4 --end-id 43 --workers 20
python3 calculate.py --work-dir ./results_E4 > result_E4.txt
python3 run_sby.py --results-dir results_E5 --end-id 43 --workers 20
